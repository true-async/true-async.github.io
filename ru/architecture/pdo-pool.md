...
> Если вы ищете руководство по использованию, см. [PDO Pool: пул соединений](/ru/docs/concepts/pdo-pool.html).
...
- [PDO Pool: пул соединений](/ru/docs/concepts/pdo-pool.html) — руководство по использованию
