...
nav_active: docs
permalink: /ru/docs/reference/task-set/join-all.html
...
- [TaskSet::joinNext](/ru/docs/reference/task-set/join-next.html) — Результат первой завершившейся задачи
- [TaskSet::joinAny](/ru/docs/reference/task-set/join-any.html) — Результат первой успешной задачи
- [TaskGroup::all](/ru/docs/reference/task-group/all.html) — Аналог без автоочистки
