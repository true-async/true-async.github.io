...
nav_active: docs
permalink: /ru/docs/reference/task-set/close.html
page_title: "TaskSet::close"
description: "Закрыть набор для новых задач."
---
...
- [TaskSet::cancel](/ru/docs/reference/task-set/cancel.html) — Отменить все задачи (неявно вызывает close)
