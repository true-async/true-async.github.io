...
nav_active: docs
permalink: /ru/docs/reference/task-set/join-any.html
...
- [TaskSet::joinNext](/ru/docs/reference/task-set/join-next.html) — Первый завершившийся (успех или ошибка)
- [TaskSet::joinAll](/ru/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::any](/ru/docs/reference/task-group/any.html) — Аналог без автоочистки
