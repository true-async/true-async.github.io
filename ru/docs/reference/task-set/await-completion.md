...
nav_active: docs
permalink: /ru/docs/reference/task-set/await-completion.html
...
Набор **должен** быть закрыт перед вызовом этого метода.
...
Бросает `Async\AsyncException`, если набор не закрыт.
...
- [TaskSet::joinAll](/ru/docs/reference/task-set/join-all.html) — Дождаться и получить результаты
- [TaskSet::finally](/ru/docs/reference/task-set/finally.html) — Обработчик завершения
