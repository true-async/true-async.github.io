...
nav_active: docs
permalink: /ru/docs/reference/task-set/join-next.html
...
- [TaskSet::joinAny](/ru/docs/reference/task-set/join-any.html) — Первый успешный результат
- [TaskSet::joinAll](/ru/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::race](/ru/docs/reference/task-group/race.html) — Аналог без автоочистки
