...
nav_active: docs
permalink: /ru/docs/components/pool.html
...
![Жизненный цикл ресурса](/diagrams/ru/components-pool/resource-lifecycle.svg)
...
Подробнее: [PDO Pool](/ru/docs/components/pdo-pool.html)

## Дальше что?

- [Архитектура Async\Pool](/ru/architecture/pool.html) — внутреннее устройство, диаграммы, C API
- [PDO Pool](/ru/docs/components/pdo-pool.html) — прозрачный пул для PDO
