...
nav_active: docs
permalink: /ru/docs/components/scope.html
page_title: "Scope"
...
- [Корутины](/ru/docs/components/coroutines.html) — как работают сами корутины
- [Отмена](/ru/docs/components/cancellation.html) — паттерны отмены операций
- [Zombie-корутины](/ru/docs/components/zombie-coroutines.html) — толерантность к чужому коду
