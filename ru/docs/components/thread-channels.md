...
| Синхронизация                     | Scheduler (кооперативно) | Мьютекс (потокобезопасно)        |
...
Значение **глубоко копируется в общую память канала** по тем же правилам, что и captured переменные
