...
layout: docs
lang: ru
path_key: "/docs/concepts/interfaces.html"
nav_active: docs
permalink: /ru/docs/concepts/interfaces.html
...
Эти интерфейсы описаны в документации [Async\Pool](/ru/docs/concepts/pool.html).
...
- [Future](/ru/docs/concepts/future.html) — обещание результата
