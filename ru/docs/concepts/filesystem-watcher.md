...
layout: docs
lang: ru
path_key: "/docs/concepts/filesystem-watcher.html"
nav_active: docs
permalink: /ru/docs/concepts/filesystem-watcher.html
...
- [Корутины](/ru/docs/concepts/coroutines.html) — базовая единица конкурентности
- [Channel](/ru/docs/concepts/channels.html) — CSP-каналы для передачи данных
- [Отмена](/ru/docs/concepts/cancellation.html) — механизм отмены операций
