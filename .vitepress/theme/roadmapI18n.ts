...
export const roadmapI18n: Record<string, RoadmapStrings> = {
  en: {
    ...
    milestones: {
      ...
      'server-ws': 'WebSocket',
      'server-grpc': 'gRPC',
      'server-topics': 'Cross-worker topics',
  ...
  ru: {
    ...
    milestones: {
      ...
      'server-ws': 'WebSocket',
      'server-grpc': 'gRPC',
      'server-topics': 'Топики между воркерами',
  ...
  de: {
    ...
    milestones: {
      ...
      'server-ws': 'WebSocket',
      'server-grpc': 'gRPC',
      'server-topics': 'Worker-übergreifende Topics',
  ...
  es: {
    ...
    milestones: {
      ...
      'server-ws': 'WebSocket',
      'server-grpc': 'gRPC',
      'server-topics': 'Topics entre workers',
  ...
  fr: {
    ...
    milestones: {
      ...
      'server-ws': 'WebSocket',
      'server-grpc': 'gRPC',
      'server-topics': 'Topics inter-workers',
  ...
  it: {
    ...
    milestones: {
      ...
      'server-ws': 'WebSocket',
      'server-grpc': 'gRPC',
      'server-topics': 'Topic tra worker',
  ...
  uk: {
    ...
    milestones: {
      ...
      'server-ws': 'WebSocket',
      'server-grpc': 'gRPC',
      'server-topics': 'Топіки між воркерами',
