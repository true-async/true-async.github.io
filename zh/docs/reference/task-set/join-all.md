...
nav_active: docs
permalink: /zh/docs/reference/task-set/join-all.html
...
- [TaskSet::joinNext](/zh/docs/reference/task-set/join-next.html) — Результат первой завершившейся задачи
- [TaskSet::joinAny](/zh/docs/reference/task-set/join-any.html) — Результат первой успешной задачи
- [TaskGroup::all](/zh/docs/reference/task-group/all.html) — Аналог без автоочистки
