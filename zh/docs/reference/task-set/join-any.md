...
nav_active: docs
permalink: /zh/docs/reference/task-set/join-any.html
...
- [TaskSet::joinNext](/zh/docs/reference/task-set/join-next.html) — Первый завершившийся (успех или ошибка)
- [TaskSet::joinAll](/zh/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::any](/zh/docs/reference/task-group/any.html) — Аналог без автоочистки
