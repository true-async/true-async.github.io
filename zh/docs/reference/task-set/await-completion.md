...
nav_active: docs
permalink: /zh/docs/reference/task-set/await-completion.html
...
- [TaskSet::joinAll](/zh/docs/reference/task-set/join-all.html) — Дождаться и получить результаты
- [TaskSet::finally](/zh/docs/reference/task-set/finally.html) — Обработчик завершения
