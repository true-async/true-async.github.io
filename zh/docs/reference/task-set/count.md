...
nav_active: docs
permalink: /zh/docs/reference/task-set/count.html
...
- [TaskSet::isFinished](/zh/docs/reference/task-set/is-finished.html) — Проверить, завершены ли все задачи
- [TaskSet::joinNext](/zh/docs/reference/task-set/join-next.html) — Получить следующий результат
