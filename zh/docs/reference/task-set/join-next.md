...
nav_active: docs
permalink: /zh/docs/reference/task-set/join-next.html
...
- [TaskSet::joinAny](/zh/docs/reference/task-set/join-any.html) — Первый успешный результат
- [TaskSet::joinAll](/zh/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::race](/zh/docs/reference/task-group/race.html) — Аналог без автоочистки
