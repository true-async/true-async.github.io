...
nav_active: docs
permalink: /zh/docs/reference/frankenphp/request.html
...
Returns uploaded files as an array of [`FrankenPHP\UploadedFile`](/zh/docs/reference/frankenphp/uploaded-file.html) objects.
...
- [FrankenPHP\Response](/zh/docs/reference/frankenphp/response.html) -- Building and sending responses
- [FrankenPHP\UploadedFile](/zh/docs/reference/frankenphp/uploaded-file.html) -- Working with uploaded files
- [FrankenPHP Integration Guide](/zh/docs/frankenphp.html) -- Installation, configuration, and deployment
