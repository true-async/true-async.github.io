...
nav_active: docs
permalink: /zh/docs/reference/frankenphp/uploaded-file.html
...
`UploadedFile` objects are returned by [`Request::getUploadedFiles()`](/zh/docs/reference/frankenphp/request.html#getuploadedfiles).
...
- [FrankenPHP\Request](/zh/docs/reference/frankenphp/request.html) -- Reading request data
