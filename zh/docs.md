...
var dZones=[
    ...
    {group:'structural',label:'结构化并发',x:140,y:295,w:400,h:85,rx:14},
    {group:'context',label:'上下文',x:185,y:390,w:230,h:85,rx:14},
    {group:'iterate',label:'iterate()',x:30,y:485,w:190,h:90,rx:14},
    {group:'resources',label:'资源与连接池',x:245,y:485,w:330,h:90,rx:14}
];
var mZones=[
    ...
    {group:'resources',label:'资源与连接池',x:155,y:495,w:220,h:190,rx:14}
];
