...
var nodes = [
    ...
    {id:'taskset',title:'TaskSet',desc:'Динамічний набір задач з автоочищенням результатів після доставки',
     ...
     url:'/uk/docs/components/task-set.html',group:'structural',order:null,w:120,h:44},
...
var subPages = {
    ...
    'taskgroup':[
        ...
        {label:'close()',url:'/uk/docs/reference/task-group/close.html'},
    ...
    'taskset':[
        ...
        {label:'close()',url:'/uk/docs/reference/task-set/close.html'}],
