...
nav_active: docs
permalink: /uk/docs/reference/frankenphp/request.html
...
Returns uploaded files as an array of [`FrankenPHP\UploadedFile`](/uk/docs/reference/frankenphp/uploaded-file.html) objects.
...
- [FrankenPHP\Response](/uk/docs/reference/frankenphp/response.html) -- Building and sending responses
- [FrankenPHP\UploadedFile](/uk/docs/reference/frankenphp/uploaded-file.html) -- Working with uploaded files
- [FrankenPHP Integration Guide](/uk/docs/frankenphp.html) -- Installation, configuration, and deployment
