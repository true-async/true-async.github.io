...
nav_active: docs
permalink: /uk/docs/reference/frankenphp/uploaded-file.html
...
`UploadedFile` objects are returned by [`Request::getUploadedFiles()`](/uk/docs/reference/frankenphp/request.html#getuploadedfiles).
...
- [FrankenPHP\Request](/uk/docs/reference/frankenphp/request.html) -- Reading request data
