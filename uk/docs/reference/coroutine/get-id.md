...
nav_active: docs
permalink: /uk/docs/reference/coroutine/get-id.html
page_title: "Coroutine::getId"
description: "Отримати унікальний ідентифікатор корутини."
---
...
Повертає унікальний цілочисельний ідентифікатор корутини. Ідентифікатор є унікальним у межах поточного процесу PHP.
...
### Приклад #2 Логування з ідентифікатором
...
- [Coroutine::getSpawnLocation](/uk/docs/reference/coroutine/get-spawn-location.html) -- Місце створення корутини
- [current_coroutine()](/uk/docs/reference/current-coroutine.html) -- Отримати поточну корутину
