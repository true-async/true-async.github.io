...
nav_active: docs
permalink: /uk/docs/reference/task-set/await-completion.html
...
- [TaskSet::joinAll](/uk/docs/reference/task-set/join-all.html) — Дождаться и получить результаты
- [TaskSet::finally](/uk/docs/reference/task-set/finally.html) — Обработчик завершения
