...
nav_active: docs
permalink: /uk/docs/reference/task-set/get-iterator.html
...
- [TaskSet::seal](/uk/docs/reference/task-set/seal.html) — Запечатать набор
- [TaskSet::joinAll](/uk/docs/reference/task-set/join-all.html) — Дождаться всех задач
- [TaskSet::joinNext](/uk/docs/reference/task-set/join-next.html) — Следующий результат
