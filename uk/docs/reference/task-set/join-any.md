...
nav_active: docs
permalink: /uk/docs/reference/task-set/join-any.html
...
- [TaskSet::joinNext](/uk/docs/reference/task-set/join-next.html) — Первый завершившийся (успех или ошибка)
- [TaskSet::joinAll](/uk/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::any](/uk/docs/reference/task-group/any.html) — Аналог без автоочистки
