...
nav_active: docs
permalink: /uk/docs/reference/task-set/join-next.html
...
- [TaskSet::joinAny](/uk/docs/reference/task-set/join-any.html) — Первый успешный результат
- [TaskSet::joinAll](/uk/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::race](/uk/docs/reference/task-group/race.html) — Аналог без автоочистки
