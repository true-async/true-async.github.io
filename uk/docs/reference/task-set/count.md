...
nav_active: docs
permalink: /uk/docs/reference/task-set/count.html
...
- [TaskSet::isFinished](/uk/docs/reference/task-set/is-finished.html) — Проверить, завершены ли все задачи
- [TaskSet::joinNext](/uk/docs/reference/task-set/join-next.html) — Получить следующий результат
