...
nav_active: docs
permalink: /uk/docs/reference/task-set/join-all.html
...
- [TaskSet::joinNext](/uk/docs/reference/task-set/join-next.html) — Результат первой завершившейся задачи
- [TaskSet::joinAny](/uk/docs/reference/task-set/join-any.html) — Результат первой успешной задачи
- [TaskGroup::all](/uk/docs/reference/task-group/all.html) — Аналог без автоочистки
