...
nav_active: docs
permalink: /en/docs/reference/frankenphp/uploaded-file.html
...
`UploadedFile` objects are returned by [`Request::getUploadedFiles()`](/en/docs/reference/frankenphp/request.html#getuploadedfiles).
...
- [FrankenPHP\Response](/en/docs/reference/frankenphp/response.html) -- Building and sending responses
