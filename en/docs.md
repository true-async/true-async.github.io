...
<p class="lm-hint" id="lmHint">Hover over a node for details. Click to go to the documentation.</p>
...
<button class="sh-close" id="lmShClose" aria-label="Close">&times;</button>
</div>
...
<a class="sh-btn" id="lmShBtn" href="#">Open documentation &rarr;</a>
</div>
<a class="lm-link" href="/en/interactive/learning-map.html">Full interactive version &rarr;</a>
<script>
(function(){
var GRP = {
    primitives:   {color:'#6B58FF',bg:'rgba(107,88,255,0.12)',border:'rgba(107,88,255,0.50)',arrow:'url(#lmArrPurple)',label:'Basic Primitives'},
    sync:         {color:'#2563EB',bg:'rgba(37,99,235,0.12)',border:'rgba(37,99,235,0.50)',arrow:'url(#lmArrBlue)',label:'Synchronization'},
    cancellation: {color:'#DC2626',bg:'rgba(220,38,38,0.12)',border:'rgba(220,38,38,0.50)',arrow:'url(#lmArrRed)',label:'Cancellation'},
    structural:   {color:'#0891B2',bg:'rgba(8,145,178,0.12)',border:'rgba(8,145,178,0.50)',arrow:'url(#lmArrTeal)',label:'Str. Concurrency'},
    ...
    resources:    {color:'#16A34A',bg:'rgba(22,163,74,0.12)',border:'rgba(22,163,74,0.50)',arrow:'url(#lmArrGreen)',label:'Resources & Pools'}
};
var lmMob=window.innerWidth<=768;
var nodes = [
    {id:'coroutines',title:'Coroutines',desc:'Basic unit of asynchrony — launching concurrent tasks',
     ...
     url:'/en/docs/components/coroutines.html',group:'primitives',order:1,w:130,h:44},
    {id:'future',title:'Future',desc:'Get the result of an asynchronous operation',
     ...
     url:'/en/docs/components/future.html',group:'primitives',order:null,w:110,h:44},
    {id:'await-funcs',title:'await, await_all',desc:'Waiting for one or more coroutines or Futures',
     ...
     url:'/en/docs/reference/await.html',group:'sync',order:2,w:160,h:44},
    {id:'channels',title:'Channels',desc:'Pass data between coroutines',
     ...
     url:'/en/docs/components/channels.html',group:'sync',order:null,w:110,h:44},
    {id:'cancellation',title:'Cancellation',desc:'Cancel coroutines',
     ...
     url:'/en/docs/components/cancellation.html',group:'cancellation',order:3,w:150,h:44},
    {id:'scope',title:'Scope',desc:'Control the lifetime of a group of coroutines',
     ...
     url:'/en/docs/components/scope.html',group:'structural',order:4,w:110,h:44},
    {id:'taskgroup',title:'TaskGroup',desc:'Structured concurrency: group tasks with guaranteed await or cancellation',
     ...
     url:'/en/docs/components/task-group.html',group:'structural',order:null,w:130,h:44},
{id:'taskset',title:'TaskSet',desc:'Dynamic task set with auto-cleanup after result delivery',code:'<span class="var">$set</span> = <span class="kw">new</span> <span class="fn">TaskSet</span>(<span class="num">10</span>);
<span class="var">$set</span>-><span class="fn">spawn</span>(<span class="var">$task</span>);
<span class="var">$r</span> = <span class="var">$set</span>-><span class="fn">joinNext</span>();',url:'/en/docs/components/task-set.html',group:'structural',order:null,w:120,h:44},
    {id:'context',title:'Context',desc:'Store data bound to a coroutine (e.g. auth token)',
     ...
     url:'/en/docs/components/context.html',group:'context',order:5,w:120,h:44},
    {id:'iterate',title:'iterate()',desc:'Concurrent collection processing',
     ...
     url:'/en/docs/reference/iterate.html',group:'iterate',order:null,w:120,h:44},
    {id:'pool',title:'Async\\Pool',desc:'Reuse expensive resources (connections, workers)',
     ...
     url:'/en/docs/components/pool.html',group:'resources',order:6,w:130,h:44},
    {id:'pdo-pool',title:'PDO Pool',desc:'PDO database connection pool. Use familiar functions transparently',
     ...
     url:'/en/docs/components/pdo-pool.html',group:'resources',order:null,w:120,h:44}
];
...
var subPages = {
    'coroutines':[
        {label:'spawn()',url:'/en/docs/reference/spawn.html'},
        {label:'spawn_with()',url:'/en/docs/reference/spawn-with.html'}],
    'future':[{label:'await()',url:'/en/docs/reference/await.html'}],
    'await-funcs':[
        {label:'await_all()',url:'/en/docs/reference/await-all.html'},
        {label:'await_first_success()',url:'/en/docs/reference/await-first-success.html'},
        {label:'delay()',url:'/en/docs/reference/delay.html'},
        {label:'suspend()',url:'/en/docs/reference/suspend.html'}],
    'cancellation':[
        {label:'cancel()',url:'/en/docs/components/cancellation.html'},
        {label:'protect()',url:'/en/docs/reference/protect.html'},
        {label:'timeout()',url:'/en/docs/reference/timeout.html'}],
    'scope':[
        {label:'Scope',url:'/en/docs/components/scope.html'},
        {label:'Scope::inherit()',url:'/en/docs/components/scope.html'}],
    'context':[
        {label:'current_context()',url:'/en/docs/reference/current-context.html'},
        {label:'coroutine_context()',url:'/en/docs/reference/coroutine-context.html'}],
    'taskgroup':[
        {label:'all()',url:'/en/docs/reference/task-group/all.html'},
        {label:'race()',url:'/en/docs/reference/task-group/race.html'},
        {label:'seal()',url:'/en/docs/reference/task-group/seal.html'},
        {label:'cancel()',url:'/en/docs/reference/task-group/cancel.html'}],
'taskset':[
        {label:'joinNext()',url:'/en/docs/reference/task-set/join-next.html'},
        {label:'joinAny()',url:'/en/docs/reference/task-set/join-any.html'},
        {label:'joinAll()',url:'/en/docs/reference/task-set/join-all.html'},
        {label:'seal()',url:'/en/docs/reference/task-set/seal.html'}],
    'pool':[{label:'Pool::tryAcquire()',url:'/en/docs/components/pool.html'}]
};
var dZones=[
    {group:'primitives',label:'Basic Primitives',x:140,y:10,w:400,h:85,rx:14},
    {group:'sync',label:'Synchronization',x:100,y:105,w:440,h:85,rx:14},
    {group:'cancellation',label:'Cancellation',x:170,y:200,w:260,h:85,rx:14},
    {group:'structural',label:'Str. Concurrency',x:140,y:295,w:470,h:85,rx:14},
    {group:'context',label:'Context',x:185,y:390,w:230,h:85,rx:14},
    {group:'iterate',label:'iterate()',x:30,y:485,w:190,h:90,rx:14},
    {group:'resources',label:'Resources & Pools',x:245,y:585,w:330,h:90,rx:14}
];
var mZones=[
    {group:'primitives',label:'Basic Primitives',x:15,y:10,w:350,h:90,rx:14},
    {group:'sync',label:'Synchronization',x:15,y:108,w:350,h:90,rx:14},
    {group:'cancellation',label:'Cancellation',x:65,y:205,w:250,h:85,rx:14},
    {group:'structural',label:'Str. Concurrency',x:15,y:300,w:350,h:190,rx:14},
...
function showTip(id,ev){
    ...
    if(n.order){oe.textContent='Step '+n.order+' of 6';oe.style.color=g.color;oe.style.display='';}
...
if(lmIsMobile){document.getElementById('lmHint').textContent='Tap a node for details.';}
