...
var nodes = [
    ...
    {id:'taskset',title:'TaskSet',desc:'Dynamic task set with auto-cleanup after result delivery',
     ...
     url:'/en/docs/components/task-set.html',group:'structural',order:null,w:120,h:44},
...
var subPages = {
    ...
    'taskgroup':[
        ...
        {label:'close()',url:'/en/docs/reference/task-group/close.html'},
    ...
    'taskset':[
        ...
        {label:'close()',url:'/en/docs/reference/task-set/close.html'}],
