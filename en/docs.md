...
var dZones=[
    ...
    {group:'structural',label:'Str. Concurrency',x:140,y:295,w:400,h:85,rx:14},
    {group:'context',label:'Context',x:185,y:390,w:230,h:85,rx:14},
    {group:'iterate',label:'iterate()',x:30,y:485,w:190,h:90,rx:14},
    {group:'resources',label:'Resources & Pools',x:245,y:485,w:330,h:90,rx:14}
];
var mZones=[
    ...
    {group:'structural',label:'Str. Concurrency',x:15,y:300,w:350,h:90,rx:14},
    {group:'context',label:'Context',x:65,y:398,w:250,h:85,rx:14},
    {group:'iterate',label:'iterate()',x:15,y:495,w:175,h:90,rx:14},
    {group:'resources',label:'Resources & Pools',x:155,y:495,w:220,h:190,rx:14}
];
