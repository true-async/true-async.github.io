...
nav_active: docs
permalink: /ko/docs/reference/task-set/join-next.html
...
- [TaskSet::joinAny](/ko/docs/reference/task-set/join-any.html) — Первый успешный результат
- [TaskSet::joinAll](/ko/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::race](/ko/docs/reference/task-group/race.html) — Аналог без автоочистки
