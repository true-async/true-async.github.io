...
nav_active: docs
permalink: /ko/docs/reference/task-set/get-iterator.html
...
- [TaskSet::close](/ko/docs/reference/task-set/close.html) — Запечатать набор
- [TaskSet::joinAll](/ko/docs/reference/task-set/join-all.html) — Дождаться всех задач
- [TaskSet::joinNext](/ko/docs/reference/task-set/join-next.html) — Следующий результат
