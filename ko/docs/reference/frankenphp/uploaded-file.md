...
nav_active: docs
permalink: /ko/docs/reference/frankenphp/uploaded-file.html
...
`UploadedFile` objects are returned by [`Request::getUploadedFiles()`](/ko/docs/reference/frankenphp/request.html#getuploadedfiles).
...
- [FrankenPHP\Request](/ko/docs/reference/frankenphp/request.html) -- Reading request data
