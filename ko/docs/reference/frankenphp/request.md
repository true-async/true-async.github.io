...
nav_active: docs
permalink: /ko/docs/reference/frankenphp/request.html
...
Returns uploaded files as an array of [`FrankenPHP\UploadedFile`](/ko/docs/reference/frankenphp/uploaded-file.html) objects.
...
- [FrankenPHP\Response](/ko/docs/reference/frankenphp/response.html) -- Building and sending responses
- [FrankenPHP\UploadedFile](/ko/docs/reference/frankenphp/uploaded-file.html) -- Working with uploaded files
- [FrankenPHP Integration Guide](/ko/docs/frankenphp.html) -- Installation, configuration, and deployment
