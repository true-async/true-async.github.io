...
## Mapa de aprendizaje {#learning-map}
...
<p class="lm-hint" id="lmHint">Pase el cursor sobre un nodo para ver los detalles. Haga clic para ir a la documentaci&oacute;n.</p>
...
<button class="sh-close" id="lmShClose" aria-label="Cerrar">&times;</button>
</div>
...
<a class="sh-btn" id="lmShBtn" href="#">Abrir documentaci&oacute;n &rarr;</a>
</div>
<a class="lm-link" href="/es/interactive/learning-map.html">Versi&oacute;n interactiva completa &rarr;</a>
<script>
(function(){
var GRP = {
    primitives:   {color:'#6B58FF',bg:'rgba(107,88,255,0.12)',border:'rgba(107,88,255,0.50)',arrow:'url(#lmArrPurple)',label:'Primitivas b\u00e1sicas'},
    sync:         {color:'#2563EB',bg:'rgba(37,99,235,0.12)',border:'rgba(37,99,235,0.50)',arrow:'url(#lmArrBlue)',label:'Sincronizaci\u00f3n'},
    cancellation: {color:'#DC2626',bg:'rgba(220,38,38,0.12)',border:'rgba(220,38,38,0.50)',arrow:'url(#lmArrRed)',label:'Cancelaci\u00f3n'},
    structural:   {color:'#0891B2',bg:'rgba(8,145,178,0.12)',border:'rgba(8,145,178,0.50)',arrow:'url(#lmArrTeal)',label:'Conc. estructurada'},
    context:      {color:'#8B5CF6',bg:'rgba(139,92,246,0.12)',border:'rgba(139,92,246,0.50)',arrow:'url(#lmArrViolet)',label:'Contexto'},
    iterate:      {color:'#F59E0B',bg:'rgba(245,158,11,0.12)',border:'rgba(245,158,11,0.50)',arrow:'url(#lmArrAmber)',label:'iterate()'},
    resources:    {color:'#16A34A',bg:'rgba(22,163,74,0.12)',border:'rgba(22,163,74,0.50)',arrow:'url(#lmArrGreen)',label:'Recursos y pools'}
};
var lmMob=window.innerWidth<=768;
var nodes = [
    {id:'coroutines',title:'Corrutinas',desc:'Unidad b\u00e1sica de asincron\u00eda \u2014 lanzar tareas concurrentes',
     ...
     url:'/es/docs/components/coroutines.html',group:'primitives',order:1,w:130,h:44},
    {id:'future',title:'Future',desc:'Obtener el resultado de una operaci\u00f3n as\u00edncrona',
     ...
     url:'/es/docs/components/future.html',group:'primitives',order:null,w:110,h:44},
    {id:'await-funcs',title:'await, await_all',desc:'Esperar una o m\u00e1s corrutinas o Futures',
     ...
     url:'/es/docs/reference/await.html',group:'sync',order:2,w:160,h:44},
    {id:'channels',title:'Canales',desc:'Pasar datos entre corrutinas',
     ...
     url:'/es/docs/components/channels.html',group:'sync',order:null,w:110,h:44},
    {id:'cancellation',title:'Cancelaci\u00f3n',desc:'Cancelar corrutinas',
     code:'<span class="var">$coro</span>-><span class="fn">cancel</span>();\n<span class="cm">// o con tiempo l\u00edmite:</span>\n<span class="fn">await</span>(<span class="var">$coro</span>, <span class="fn">timeout</span>(<span class="num">5000</span>));',
     url:'/es/docs/components/cancellation.html',group:'cancellation',order:3,w:150,h:44},
    {id:'scope',title:'Scope',desc:'Controlar el ciclo de vida de un grupo de corrutinas',
     ...
     url:'/es/docs/components/scope.html',group:'structural',order:4,w:110,h:44},
    {id:'taskgroup',title:'TaskGroup',desc:'Concurrencia estructurada: agrupar tareas con espera o cancelaci\u00f3n garantizada',
     ...
     url:'/es/docs/components/task-group.html',group:'structural',order:null,w:130,h:44},
{id:'taskset',title:'TaskSet',desc:'Conjunto dinámico de tareas con limpieza automática tras la entrega',code:'<span class="var">$set</span> = <span class="kw">new</span> <span class="fn">TaskSet</span>(<span class="num">10</span>);
<span class="var">$set</span>-><span class="fn">spawn</span>(<span class="var">$task</span>);
<span class="var">$r</span> = <span class="var">$set</span>-><span class="fn">joinNext</span>();',url:'/es/docs/components/task-set.html',group:'structural',order:null,w:120,h:44},
    {id:'context',title:'Contexto',desc:'Almacenar datos vinculados a una corrutina (p. ej. token de autenticaci\u00f3n)',
     ...
     url:'/es/docs/components/context.html',group:'context',order:5,w:120,h:44},
    {id:'iterate',title:'iterate()',desc:'Procesamiento concurrente de colecciones',
     ...
     url:'/es/docs/reference/iterate.html',group:'iterate',order:null,w:120,h:44},
    {id:'pool',title:'Async\\Pool',desc:'Reutilizar recursos costosos (conexiones, workers)',
     ...
     url:'/es/docs/components/pool.html',group:'resources',order:6,w:130,h:44},
    {id:'pdo-pool',title:'PDO Pool',desc:'Pool de conexiones PDO a bases de datos. Use funciones familiares de forma transparente',
     ...
     url:'/es/docs/components/pdo-pool.html',group:'resources',order:null,w:120,h:44}
];
...
var subPages = {
    'coroutines':[
        {label:'spawn()',url:'/es/docs/reference/spawn.html'},
        {label:'spawn_with()',url:'/es/docs/reference/spawn-with.html'}],
    'future':[{label:'await()',url:'/es/docs/reference/await.html'}],
    'await-funcs':[
        {label:'await_all()',url:'/es/docs/reference/await-all.html'},
        {label:'await_first_success()',url:'/es/docs/reference/await-first-success.html'},
        {label:'delay()',url:'/es/docs/reference/delay.html'},
        {label:'suspend()',url:'/es/docs/reference/suspend.html'}],
    'cancellation':[
        {label:'cancel()',url:'/es/docs/components/cancellation.html'},
        {label:'protect()',url:'/es/docs/reference/protect.html'},
        {label:'timeout()',url:'/es/docs/reference/timeout.html'}],
    'scope':[
        {label:'Scope',url:'/es/docs/components/scope.html'},
        {label:'Scope::inherit()',url:'/es/docs/components/scope.html'}],
    'context':[
        {label:'current_context()',url:'/es/docs/reference/current-context.html'},
        {label:'coroutine_context()',url:'/es/docs/reference/coroutine-context.html'}],
    'taskgroup':[
...
var dZones=[
    {group:'primitives',label:'Primitivas b\u00e1sicas',x:140,y:10,w:400,h:85,rx:14},
    {group:'sync',label:'Sincronizaci\u00f3n',x:100,y:105,w:440,h:85,rx:14},
    {group:'cancellation',label:'Cancelaci\u00f3n',x:170,y:200,w:260,h:85,rx:14},
    {group:'structural',label:'Conc. estructurada',x:140,y:295,w:470,h:85,rx:14},
    {group:'context',label:'Contexto',x:185,y:390,w:230,h:85,rx:14},
    {group:'iterate',label:'iterate()',x:30,y:485,w:190,h:90,rx:14},
    {group:'resources',label:'Recursos y pools',x:245,y:585,w:330,h:90,rx:14}
];
var mZones=[
    {group:'primitives',label:'Primitivas b\u00e1sicas',x:15,y:10,w:350,h:90,rx:14},
    {group:'sync',label:'Sincronizaci\u00f3n',x:15,y:108,w:350,h:90,rx:14},
    {group:'cancellation',label:'Cancelaci\u00f3n',x:65,y:205,w:250,h:85,rx:14},
    {group:'structural',label:'Conc. estructurada',x:15,y:300,w:350,h:190,rx:14},
    {group:'context',label:'Contexto',x:65,y:498,w:250,h:85,rx:14},
...
function showTip(id,ev){
    ...
    if(n.order){oe.textContent='Paso '+n.order+' de 6';oe.style.color=g.color;oe.style.display='';}
...
if(lmIsMobile){document.getElementById('lmHint').textContent='Toque un nodo para ver los detalles.';}
