...
- **Corrección de errores** — revise los [issues abiertos](https://github.com/true-async/php-async/issues){:target="_blank"}
  con la etiqueta `good first issue` para empezar
- **Nuevas funcionalidades** — discuta su idea en [Discussions](https://github.com/orgs/true-async/discussions){:target="_blank"}
...
- **Responda preguntas** en [GitHub Discussions](https://github.com/orgs/true-async/discussions){:target="_blank"}
...
| [php-async](https://github.com/true-async/php-async){:target="_blank"} | Extensión con implementación |
...
- **GitHub Discussions** — [preguntas e ideas](https://github.com/orgs/true-async/discussions){:target="_blank"}
- **Discord** — [chat en vivo](https://discord.gg/yqBQPBHKp5){:target="_blank"}
- **Issues** — [reportes de errores](https://github.com/true-async/php-async/issues){:target="_blank"}
