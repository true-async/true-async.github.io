...
nav_active: docs
permalink: /es/docs/reference/frankenphp/request.html
...
Returns uploaded files as an array of [`FrankenPHP\UploadedFile`](/es/docs/reference/frankenphp/uploaded-file.html) objects.
...
- [FrankenPHP\Response](/es/docs/reference/frankenphp/response.html) -- Building and sending responses
- [FrankenPHP\UploadedFile](/es/docs/reference/frankenphp/uploaded-file.html) -- Working with uploaded files
- [FrankenPHP Integration Guide](/es/docs/frankenphp.html) -- Installation, configuration, and deployment
