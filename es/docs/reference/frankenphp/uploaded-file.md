...
nav_active: docs
permalink: /es/docs/reference/frankenphp/uploaded-file.html
...
`UploadedFile` objects are returned by [`Request::getUploadedFiles()`](/es/docs/reference/frankenphp/request.html#getuploadedfiles).
...
- [FrankenPHP\Request](/es/docs/reference/frankenphp/request.html) -- Reading request data
