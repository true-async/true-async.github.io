...
Una vez que el buffer se ha vaciado y el canal está cerrado, `recv()` lanza `ThreadChannelException`.
...
- Lanza `Async\ThreadChannelException` si el canal está cerrado y el buffer está vacío.
