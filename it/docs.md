...
var nodes = [
    ...
    {id:'taskset',title:'TaskSet',desc:'Insieme dinamico di task con pulizia automatica dopo la consegna',
     ...
     url:'/it/docs/components/task-set.html',group:'structural',order:null,w:120,h:44},
...
var subPages = {
    ...
    'taskgroup':[
        ...
        {label:'close()',url:'/it/docs/reference/task-group/close.html'},
    ...
    'taskset':[
        ...
        {label:'close()',url:'/it/docs/reference/task-set/close.html'}],
