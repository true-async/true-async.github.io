...
nav_active: docs
permalink: /it/docs/reference/frankenphp/request.html
...
Returns uploaded files as an array of [`FrankenPHP\UploadedFile`](/it/docs/reference/frankenphp/uploaded-file.html) objects.
...
- [FrankenPHP\UploadedFile](/it/docs/reference/frankenphp/uploaded-file.html) -- Working with uploaded files
