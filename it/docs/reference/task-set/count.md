...
nav_active: docs
permalink: /it/docs/reference/task-set/count.html
...
- [TaskSet::isFinished](/it/docs/reference/task-set/is-finished.html) — Проверить, завершены ли все задачи
- [TaskSet::joinNext](/it/docs/reference/task-set/join-next.html) — Получить следующий результат
