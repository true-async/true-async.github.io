...
nav_active: docs
permalink: /it/docs/reference/task-set/get-iterator.html
...
- [TaskSet::close](/it/docs/reference/task-set/close.html) — Запечатать набор
- [TaskSet::joinAll](/it/docs/reference/task-set/join-all.html) — Дождаться всех задач
- [TaskSet::joinNext](/it/docs/reference/task-set/join-next.html) — Следующий результат
