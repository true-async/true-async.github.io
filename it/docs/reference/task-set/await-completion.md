...
nav_active: docs
permalink: /it/docs/reference/task-set/await-completion.html
...
- [TaskSet::joinAll](/it/docs/reference/task-set/join-all.html) — Дождаться и получить результаты
- [TaskSet::finally](/it/docs/reference/task-set/finally.html) — Обработчик завершения
