...
nav_active: docs
permalink: /it/docs/reference/task-set/join-any.html
...
- [TaskSet::joinNext](/it/docs/reference/task-set/join-next.html) — Первый завершившийся (успех или ошибка)
- [TaskSet::joinAll](/it/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::any](/it/docs/reference/task-group/any.html) — Аналог без автоочистки
