...
WebSocket, SSE e gRPC sono già progettati attorno allo stesso modello di un unico listener con
rilevamento del protocollo, ma sono ancora in lavorazione (vedi [Roadmap](#funzionalità)).
