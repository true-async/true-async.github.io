...
- **Correzione bug** — controlla le [issue aperte](https://github.com/true-async/php-async/issues){:target="_blank"}
  con l'etichetta `good first issue` per iniziare
- **Nuove funzionalità** — discuti la tua idea nelle [Discussions](https://github.com/orgs/true-async/discussions){:target="_blank"}
...
- **Rispondi alle domande** su [GitHub Discussions](https://github.com/orgs/true-async/discussions){:target="_blank"}
...
| [php-async](https://github.com/true-async/php-async){:target="_blank"} | Estensione con implementazione |
...
- **GitHub Discussions** — [domande e idee](https://github.com/orgs/true-async/discussions){:target="_blank"}
- **Discord** — [chat dal vivo](https://discord.gg/yqBQPBHKp5){:target="_blank"}
- **Issues** — [segnalazioni bug](https://github.com/true-async/php-async/issues){:target="_blank"}
