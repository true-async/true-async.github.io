...
description: "Das Set für neue Tasks schließen."
---
...
Geschlossen das Set. Danach werfen `spawn()` und `spawnWithKey()` eine Exception.
...
- [TaskSet::cancel](/de/docs/reference/task-set/cancel.html) — Alle Tasks abbrechen (ruft implizit close auf)
