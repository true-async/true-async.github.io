...
nav_active: docs
permalink: /de/docs/reference/frankenphp/request.html
...
Returns uploaded files as an array of [`FrankenPHP\UploadedFile`](/de/docs/reference/frankenphp/uploaded-file.html) objects.
...
- [FrankenPHP\Response](/de/docs/reference/frankenphp/response.html) -- Building and sending responses
- [FrankenPHP\UploadedFile](/de/docs/reference/frankenphp/uploaded-file.html) -- Working with uploaded files
- [FrankenPHP Integration Guide](/de/docs/frankenphp.html) -- Installation, configuration, and deployment
