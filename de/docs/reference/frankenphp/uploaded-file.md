...
nav_active: docs
permalink: /de/docs/reference/frankenphp/uploaded-file.html
...
`UploadedFile` objects are returned by [`Request::getUploadedFiles()`](/de/docs/reference/frankenphp/request.html#getuploadedfiles).
...
- [FrankenPHP\Request](/de/docs/reference/frankenphp/request.html) -- Reading request data
