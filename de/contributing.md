...
Wenn Sie etwas besprechen möchten — schreiben Sie im Projektforum oder kontaktieren Sie mich persönlich:
...
- **Bugfixes** — schauen Sie sich [offene Issues](https://github.com/true-async/php-async/issues){:target="_blank"}
  mit dem Label `good first issue` an
- **Neue Features** — besprechen Sie Ihre Idee in den [Discussions](https://github.com/orgs/true-async/discussions){:target="_blank"}
...
- **Beantworten Sie Fragen** in [GitHub Discussions](https://github.com/orgs/true-async/discussions){:target="_blank"}
...
| [php-async](https://github.com/true-async/php-async){:target="_blank"} | Erweiterung mit Implementierung |
...
- **GitHub Discussions** — [Fragen und Ideen](https://github.com/orgs/true-async/discussions){:target="_blank"}
- **Discord** — [Live-Chat](https://discord.gg/yqBQPBHKp5){:target="_blank"}
- **Issues** — [Fehlerberichte](https://github.com/true-async/php-async/issues){:target="_blank"}
