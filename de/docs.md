...
var nodes = [
    ...
    {id:'taskset',title:'TaskSet',desc:'Dynamisches Aufgabenset mit Auto-Bereinigung nach Zustellung',
     ...
     url:'/de/docs/components/task-set.html',group:'structural',order:null,w:120,h:44},
...
var subPages = {
    ...
    'taskgroup':[
        ...
        {label:'close()',url:'/de/docs/reference/task-group/close.html'},
    ...
    'taskset':[
        ...
        {label:'close()',url:'/de/docs/reference/task-set/close.html'}],
