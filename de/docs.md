...
path_key: "/docs.html"
nav_active: docs
permalink: /de/docs.html
page_title: "Dokumentation"
description: "TrueAsync-Dokumentation. Erfahren Sie, wie Sie echte asynchrone Primitive für PHP installieren und verwenden."
---

## Einführung {#introduction}

`PHP TrueAsync` ist ein Projekt, das echte Asynchronität in PHP implementiert, indem es den Zend-Kern, die I/O-Bibliothek,
Datenbankbibliotheken, Socket-Bibliotheken und andere Funktionen modifiziert.
...
<p class="lm-hint" id="lmHint">Fahren Sie mit der Maus über einen Knoten, um Details zu sehen. Klicken Sie, um zur Dokumentation zu gelangen.</p>
...
<button class="sh-close" id="lmShClose" aria-label="Schliessen">&times;</button>
</div>
...
<a class="sh-btn" id="lmShBtn" href="#">Dokumentation öffnen &rarr;</a>
</div>
<a class="lm-link" href="/de/interactive/learning-map.html">Vollständige interaktive Version &rarr;</a>
<script>
(function(){
var GRP = {
    primitives:   {color:'#6B58FF',bg:'rgba(107,88,255,0.12)',border:'rgba(107,88,255,0.50)',arrow:'url(#lmArrPurple)',label:'Grundlegende Primitive'},
    sync:         {color:'#2563EB',bg:'rgba(37,99,235,0.12)',border:'rgba(37,99,235,0.50)',arrow:'url(#lmArrBlue)',label:'Synchronisation'},
    cancellation: {color:'#DC2626',bg:'rgba(220,38,38,0.12)',border:'rgba(220,38,38,0.50)',arrow:'url(#lmArrRed)',label:'Abbruch'},
    structural:   {color:'#0891B2',bg:'rgba(8,145,178,0.12)',border:'rgba(8,145,178,0.50)',arrow:'url(#lmArrTeal)',label:'Str. Nebenläufigkeit'},
    context:      {color:'#8B5CF6',bg:'rgba(139,92,246,0.12)',border:'rgba(139,92,246,0.50)',arrow:'url(#lmArrViolet)',label:'Kontext'},
    iterate:      {color:'#F59E0B',bg:'rgba(245,158,11,0.12)',border:'rgba(245,158,11,0.50)',arrow:'url(#lmArrAmber)',label:'iterate()'},
    resources:    {color:'#16A34A',bg:'rgba(22,163,74,0.12)',border:'rgba(22,163,74,0.50)',arrow:'url(#lmArrGreen)',label:'Ressourcen & Pools'}
};
var lmMob=window.innerWidth<=768;
var nodes = [
    {id:'coroutines',title:'Koroutinen',desc:'Grundeinheit der Asynchronität — nebenläufige Aufgaben starten',
     ...
     url:'/de/docs/components/coroutines.html',group:'primitives',order:1,w:130,h:44},
    {id:'future',title:'Future',desc:'Ergebnis einer asynchronen Operation abrufen',
     ...
     url:'/de/docs/components/future.html',group:'primitives',order:null,w:110,h:44},
    {id:'await-funcs',title:'await, await_all',desc:'Warten auf eine oder mehrere Koroutinen oder Futures',
     ...
     url:'/de/docs/reference/await.html',group:'sync',order:2,w:160,h:44},
    {id:'channels',title:'Channels',desc:'Daten zwischen Koroutinen austauschen',
     ...
     url:'/de/docs/components/channels.html',group:'sync',order:null,w:110,h:44},
    {id:'cancellation',title:'Abbruch',desc:'Koroutinen abbrechen',
     code:'<span class="var">$coro</span>-><span class="fn">cancel</span>();\n<span class="cm">// oder mit Timeout:</span>\n<span class="fn">await</span>(<span class="var">$coro</span>, <span class="fn">timeout</span>(<span class="num">5000</span>));',
     url:'/de/docs/components/cancellation.html',group:'cancellation',order:3,w:150,h:44},
    {id:'scope',title:'Scope',desc:'Lebensdauer einer Gruppe von Koroutinen steuern',
     ...
     url:'/de/docs/components/scope.html',group:'structural',order:4,w:110,h:44},
    {id:'taskgroup',title:'TaskGroup',desc:'Strukturierte Nebenläufigkeit: Aufgaben gruppieren mit garantiertem Await oder Abbruch',
     ...
     url:'/de/docs/components/task-group.html',group:'structural',order:null,w:130,h:44},
{id:'taskset',title:'TaskSet',desc:'Dynamisches Aufgabenset mit Auto-Bereinigung nach Zustellung',code:'<span class="var">$set</span> = <span class="kw">new</span> <span class="fn">TaskSet</span>(<span class="num">10</span>);
<span class="var">$set</span>-><span class="fn">spawn</span>(<span class="var">$task</span>);
<span class="var">$r</span> = <span class="var">$set</span>-><span class="fn">joinNext</span>();',url:'/de/docs/components/task-set.html',group:'structural',order:null,w:120,h:44},
    {id:'context',title:'Kontext',desc:'Daten an eine Koroutine binden (z.B. Auth-Token)',
     ...
     url:'/de/docs/components/context.html',group:'context',order:5,w:120,h:44},
    {id:'iterate',title:'iterate()',desc:'Nebenläufige Sammlungsverarbeitung',
     ...
     url:'/de/docs/reference/iterate.html',group:'iterate',order:null,w:120,h:44},
    {id:'pool',title:'Async\\Pool',desc:'Teure Ressourcen wiederverwenden (Verbindungen, Worker)',
     ...
     url:'/de/docs/components/pool.html',group:'resources',order:6,w:130,h:44},
    {id:'pdo-pool',title:'PDO Pool',desc:'PDO-Datenbankverbindungspool. Vertraute Funktionen transparent nutzen',
     ...
     url:'/de/docs/components/pdo-pool.html',group:'resources',order:null,w:120,h:44}
];
...
var subPages = {
    'coroutines':[
        {label:'spawn()',url:'/de/docs/reference/spawn.html'},
        {label:'spawn_with()',url:'/de/docs/reference/spawn-with.html'}],
    'future':[{label:'await()',url:'/de/docs/reference/await.html'}],
    'await-funcs':[
        {label:'await_all()',url:'/de/docs/reference/await-all.html'},
        {label:'await_first_success()',url:'/de/docs/reference/await-first-success.html'},
        {label:'delay()',url:'/de/docs/reference/delay.html'},
        {label:'suspend()',url:'/de/docs/reference/suspend.html'}],
    'cancellation':[
        {label:'cancel()',url:'/de/docs/components/cancellation.html'},
        {label:'protect()',url:'/de/docs/reference/protect.html'},
        {label:'timeout()',url:'/de/docs/reference/timeout.html'}],
    'scope':[
        {label:'Scope',url:'/de/docs/components/scope.html'},
        {label:'Scope::inherit()',url:'/de/docs/components/scope.html'}],
    'context':[
        {label:'current_context()',url:'/de/docs/reference/current-context.html'},
        {label:'coroutine_context()',url:'/de/docs/reference/coroutine-context.html'}],
    'taskgroup':[
        {label:'all()',url:'/de/docs/reference/task-group/all.html'},
        {label:'race()',url:'/de/docs/reference/task-group/race.html'},
        {label:'seal()',url:'/de/docs/reference/task-group/seal.html'},
        {label:'cancel()',url:'/de/docs/reference/task-group/cancel.html'}],
'taskset':[
        {label:'joinNext()',url:'/de/docs/reference/task-set/join-next.html'},
        {label:'joinAny()',url:'/de/docs/reference/task-set/join-any.html'},
        {label:'joinAll()',url:'/de/docs/reference/task-set/join-all.html'},
        {label:'seal()',url:'/de/docs/reference/task-set/seal.html'}],
    'pool':[{label:'Pool::tryAcquire()',url:'/de/docs/components/pool.html'}]
};
var dZones=[
    {group:'primitives',label:'Grundlegende Primitive',x:140,y:10,w:400,h:85,rx:14},
    {group:'sync',label:'Synchronisation',x:100,y:105,w:440,h:85,rx:14},
    {group:'cancellation',label:'Abbruch',x:170,y:200,w:260,h:85,rx:14},
    {group:'structural',label:'Str. Nebenläufigkeit',x:140,y:295,w:470,h:85,rx:14},
    {group:'context',label:'Kontext',x:185,y:390,w:230,h:85,rx:14},
    {group:'iterate',label:'iterate()',x:30,y:485,w:190,h:90,rx:14},
    {group:'resources',label:'Ressourcen & Pools',x:245,y:585,w:330,h:90,rx:14}
];
var mZones=[
    {group:'primitives',label:'Grundlegende Primitive',x:15,y:10,w:350,h:90,rx:14},
    {group:'sync',label:'Synchronisation',x:15,y:108,w:350,h:90,rx:14},
    {group:'cancellation',label:'Abbruch',x:65,y:205,w:250,h:85,rx:14},
    {group:'structural',label:'Str. Nebenläufigkeit',x:15,y:300,w:350,h:190,rx:14},
    {group:'context',label:'Kontext',x:65,y:498,w:250,h:85,rx:14},
...
function showTip(id,ev){
    ...
    if(n.order){oe.textContent='Schritt '+n.order+' von 6';oe.style.color=g.color;oe.style.display='';}
...
if(lmIsMobile){document.getElementById('lmHint').textContent='Tippen Sie auf einen Knoten für Details.';}
