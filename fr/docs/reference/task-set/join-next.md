...
nav_active: docs
permalink: /fr/docs/reference/task-set/join-next.html
...
- [TaskSet::joinAny](/fr/docs/reference/task-set/join-any.html) — Первый успешный результат
- [TaskSet::joinAll](/fr/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::race](/fr/docs/reference/task-group/race.html) — Аналог без автоочистки
