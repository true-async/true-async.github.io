...
nav_active: docs
permalink: /fr/docs/reference/task-set/cancel.html
...
- [TaskSet::close](/fr/docs/reference/task-set/close.html) — Запечатать набор
- [TaskSet::dispose](/fr/docs/reference/task-set/dispose.html) — Уничтожить scope набора
