...
nav_active: docs
permalink: /fr/docs/reference/task-set/join-any.html
...
- [TaskSet::joinNext](/fr/docs/reference/task-set/join-next.html) — Первый завершившийся (успех или ошибка)
- [TaskSet::joinAll](/fr/docs/reference/task-set/join-all.html) — Все результаты
- [TaskGroup::any](/fr/docs/reference/task-group/any.html) — Аналог без автоочистки
