...
nav_active: docs
permalink: /fr/docs/reference/task-set/count.html
...
- [TaskSet::isFinished](/fr/docs/reference/task-set/is-finished.html) — Проверить, завершены ли все задачи
- [TaskSet::joinNext](/fr/docs/reference/task-set/join-next.html) — Получить следующий результат
