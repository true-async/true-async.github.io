...
nav_active: docs
permalink: /fr/docs/reference/task-set/join-all.html
...
- [TaskSet::joinNext](/fr/docs/reference/task-set/join-next.html) — Результат первой завершившейся задачи
- [TaskSet::joinAny](/fr/docs/reference/task-set/join-any.html) — Результат первой успешной задачи
- [TaskGroup::all](/fr/docs/reference/task-group/all.html) — Аналог без автоочистки
