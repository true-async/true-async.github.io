...
nav_active: docs
permalink: /fr/docs/reference/task-set/await-completion.html
...
- [TaskSet::joinAll](/fr/docs/reference/task-set/join-all.html) — Дождаться и получить результаты
- [TaskSet::finally](/fr/docs/reference/task-set/finally.html) — Обработчик завершения
