...
nav_active: docs
permalink: /fr/docs/reference/frankenphp/uploaded-file.html
...
`UploadedFile` objects are returned by [`Request::getUploadedFiles()`](/fr/docs/reference/frankenphp/request.html#getuploadedfiles).
...
- [FrankenPHP\Request](/fr/docs/reference/frankenphp/request.html) -- Reading request data
