...
## Carte d'apprentissage {#learning-map}
...
<p class="lm-hint" id="lmHint">Survolez un n&oelig;ud pour plus de d&eacute;tails. Cliquez pour acc&eacute;der &agrave; la documentation.</p>
...
<button class="sh-close" id="lmShClose" aria-label="Fermer">&times;</button>
</div>
...
<a class="sh-btn" id="lmShBtn" href="#">Ouvrir la documentation &rarr;</a>
</div>
<a class="lm-link" href="/fr/interactive/learning-map.html">Version interactive compl&egrave;te &rarr;</a>
<script>
(function(){
var GRP = {
    primitives:   {color:'#6B58FF',bg:'rgba(107,88,255,0.12)',border:'rgba(107,88,255,0.50)',arrow:'url(#lmArrPurple)',label:'Primitives de base'},
    sync:         {color:'#2563EB',bg:'rgba(37,99,235,0.12)',border:'rgba(37,99,235,0.50)',arrow:'url(#lmArrBlue)',label:'Synchronisation'},
    cancellation: {color:'#DC2626',bg:'rgba(220,38,38,0.12)',border:'rgba(220,38,38,0.50)',arrow:'url(#lmArrRed)',label:'Annulation'},
    structural:   {color:'#0891B2',bg:'rgba(8,145,178,0.12)',border:'rgba(8,145,178,0.50)',arrow:'url(#lmArrTeal)',label:'Conc. structur\u00e9e'},
    context:      {color:'#8B5CF6',bg:'rgba(139,92,246,0.12)',border:'rgba(139,92,246,0.50)',arrow:'url(#lmArrViolet)',label:'Contexte'},
    iterate:      {color:'#F59E0B',bg:'rgba(245,158,11,0.12)',border:'rgba(245,158,11,0.50)',arrow:'url(#lmArrAmber)',label:'iterate()'},
    resources:    {color:'#16A34A',bg:'rgba(22,163,74,0.12)',border:'rgba(22,163,74,0.50)',arrow:'url(#lmArrGreen)',label:'Ressources et pools'}
};
var lmMob=window.innerWidth<=768;
var nodes = [
    {id:'coroutines',title:'Coroutines',desc:'Unit\u00e9 de base de l\u2019asynchronie \u2014 lancer des t\u00e2ches concurrentes',
     ...
     url:'/fr/docs/components/coroutines.html',group:'primitives',order:1,w:130,h:44},
    {id:'future',title:'Future',desc:'Obtenir le r\u00e9sultat d\u2019une op\u00e9ration asynchrone',
     ...
     url:'/fr/docs/components/future.html',group:'primitives',order:null,w:110,h:44},
    {id:'await-funcs',title:'await, await_all',desc:'Attendre une ou plusieurs coroutines ou Futures',
     ...
     url:'/fr/docs/reference/await.html',group:'sync',order:2,w:160,h:44},
    {id:'channels',title:'Canaux',desc:'Transmettre des donn\u00e9es entre coroutines',
     ...
     url:'/fr/docs/components/channels.html',group:'sync',order:null,w:110,h:44},
    {id:'cancellation',title:'Annulation',desc:'Annuler des coroutines',
     code:'<span class="var">$coro</span>-><span class="fn">cancel</span>();\n<span class="cm">// ou avec un d\u00e9lai :</span>\n<span class="fn">await</span>(<span class="var">$coro</span>, <span class="fn">timeout</span>(<span class="num">5000</span>));',
     url:'/fr/docs/components/cancellation.html',group:'cancellation',order:3,w:150,h:44},
    {id:'scope',title:'Scope',desc:'Contr\u00f4ler la dur\u00e9e de vie d\u2019un groupe de coroutines',
     ...
     url:'/fr/docs/components/scope.html',group:'structural',order:4,w:110,h:44},
    ...
    {id:'iterate',title:'iterate()',desc:'Traitement concurrent de collections',
     ...
     url:'/fr/docs/reference/iterate.html',group:'iterate',order:null,w:120,h:44},
    {id:'pool',title:'Async\\Pool',desc:'R\u00e9utiliser des ressources co\u00fbteuses (connexions, workers)',
     ...
     url:'/fr/docs/components/pool.html',group:'resources',order:6,w:130,h:44},
    {id:'pdo-pool',title:'PDO Pool',desc:'Pool de connexions PDO. Utilisez les fonctions habituelles de mani\u00e8re transparente',
     ...
     url:'/fr/docs/components/pdo-pool.html',group:'resources',order:null,w:120,h:44}
];
...
var subPages = {
    'coroutines':[
        {label:'spawn()',url:'/fr/docs/reference/spawn.html'},
        {label:'spawn_with()',url:'/fr/docs/reference/spawn-with.html'}],
    'future':[{label:'await()',url:'/fr/docs/reference/await.html'}],
    'await-funcs':[
        {label:'await_all()',url:'/fr/docs/reference/await-all.html'},
        {label:'await_first_success()',url:'/fr/docs/reference/await-first-success.html'},
        {label:'delay()',url:'/fr/docs/reference/delay.html'},
        {label:'suspend()',url:'/fr/docs/reference/suspend.html'}],
    'cancellation':[
        {label:'cancel()',url:'/fr/docs/components/cancellation.html'},
        {label:'protect()',url:'/fr/docs/reference/protect.html'},
        {label:'timeout()',url:'/fr/docs/reference/timeout.html'}],
    'scope':[
        {label:'Scope',url:'/fr/docs/components/scope.html'},
        {label:'Scope::inherit()',url:'/fr/docs/components/scope.html'}],
    'context':[
        {label:'current_context()',url:'/fr/docs/reference/current-context.html'},
        {label:'coroutine_context()',url:'/fr/docs/reference/coroutine-context.html'}],
    'taskgroup':[
        {label:'all()',url:'/fr/docs/reference/task-group/all.html'},
        {label:'race()',url:'/fr/docs/reference/task-group/race.html'},
        {label:'close()',url:'/fr/docs/reference/task-group/close.html'},
    ...
    'taskset':[
        ...
        {label:'close()',url:'/fr/docs/reference/task-set/close.html'}],
    'pool':[{label:'Pool::tryAcquire()',url:'/fr/docs/components/pool.html'}]
};
var dZones=[
    {group:'primitives',label:'Primitives de base',x:140,y:10,w:400,h:85,rx:14},
    {group:'sync',label:'Synchronisation',x:100,y:105,w:440,h:85,rx:14},
    {group:'cancellation',label:'Annulation',x:170,y:200,w:260,h:85,rx:14},
    {group:'structural',label:'Conc. structur\u00e9e',x:140,y:295,w:470,h:85,rx:14},
    {group:'context',label:'Contexte',x:185,y:390,w:230,h:85,rx:14},
    {group:'iterate',label:'iterate()',x:30,y:485,w:190,h:90,rx:14},
    {group:'resources',label:'Ressources et pools',x:245,y:585,w:330,h:90,rx:14}
];
var mZones=[
    {group:'primitives',label:'Primitives de base',x:15,y:10,w:350,h:90,rx:14},
    {group:'sync',label:'Synchronisation',x:15,y:108,w:350,h:90,rx:14},
    {group:'cancellation',label:'Annulation',x:65,y:205,w:250,h:85,rx:14},
    {group:'structural',label:'Conc. structur\u00e9e',x:15,y:300,w:350,h:190,rx:14},
    {group:'context',label:'Contexte',x:65,y:498,w:250,h:85,rx:14},
...
function showTip(id,ev){
    ...
    if(n.order){oe.textContent='\u00c9tape '+n.order+' sur 6';oe.style.color=g.color;oe.style.display='';}
...
if(lmIsMobile){document.getElementById('lmHint').textContent='Appuyez sur un n\u0153ud pour plus de d\u00e9tails.';}
