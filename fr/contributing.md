...
Si vous souhaitez discuter de quelque chose, écrivez sur le forum du projet ou contactez-moi personnellement :

<div style="display: flex; gap: 1rem; flex-wrap: wrap; margin: 1rem 0;">
  <a href="https://github.com/orgs/true-async/discussions" target="_blank" class="contact-btn">
  ...
  <a href="https://discord.gg/yqBQPBHKp5" target="_blank" class="contact-btn">
  ...
  <a href="mailto:edmondifthen@proton.me" class="contact-btn">
    &#9993; Email
  </a>
</div>
...
- **Corrections de bugs** — consultez les [issues ouvertes](https://github.com/true-async/php-async/issues){:target="_blank"}
  avec le label `good first issue` pour commencer
- **Nouvelles fonctionnalités** — discutez votre idée dans les [Discussions](https://github.com/orgs/true-async/discussions){:target="_blank"}
  avant de l'implémenter
- **Revue de code** — aidez à réviser les pull requests, c'est une contribution précieuse

### Documentation

- **Corrections** — trouvé une inexactitude ? Cliquez sur « Modifier cette page » en bas de chaque page
...
- **Répondez aux questions** sur [GitHub Discussions](https://github.com/orgs/true-async/discussions){:target="_blank"}
...
- **GitHub Discussions** — [questions et idées](https://github.com/orgs/true-async/discussions){:target="_blank"}
- **Discord** — [chat en direct](https://discord.gg/yqBQPBHKp5){:target="_blank"}
- **Issues** — [rapports de bugs](https://github.com/true-async/php-async/issues){:target="_blank"}
